...
class ModelArguments:
    ...
    model_name_or_path: str = field(
        default="microsoft/tapex-large-finetuned-tabfact", metadata={"help": "Path to pretrained model or model identifier from huggingface.co/models"}
    )
