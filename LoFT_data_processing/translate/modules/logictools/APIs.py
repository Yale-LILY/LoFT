...
APIs["maximum"] = {"argument": ['row', 'row', 'header'], "output": "bool",
                    ...
                    "to_nl": lambda r1, r2, col: f"( {col} ) of ( {r2} ) is the greatest of ( {col} ) of ( {r1} )",
                    "append": None}
...
APIs["minimum"] = {"argument": ['row', 'row', 'header'], "output": "bool",
                    ...
                    "to_nl": lambda r1, r2, col: f"( {col} ) of ( {r2} ) is the smallest of ( {col} ) of ( {r1} )",
                    "append": None}
...
APIs["hop_str_contain_not_any"] = {"argument": ['row', 'header', 'obj'], "output": "bool",
                                    ...
                                    "to_nl": lambda t, col, value: f"( {value} ) exists under ( {col} ) of ( {t} )",
                                    "append": None}
...
APIs["hop_str_contain_any"] = {"argument": ['row', 'header', 'obj'], "output": "bool",
                                ...
                                "to_nl": lambda t, col, value: f"( {value} ) does not exist under ( {col} ) of ( {t} )",
                                "append": None}
...
APIs["hop_eq"] = {"argument": ['row', 'header', 'obj'], "output": "bool",
                    ...
                    "to_nl": lambda t, col, value: f"( {col} ) of ( {t} ) equals to ( {value} )",
                    "append": None}
...
APIs["hop_not_eq"] = {"argument": ['row', 'header', 'obj'], "output": "bool",
                        ...
                        "to_nl": lambda t, col, value: f"( {col} ) of ( {t} ) does not equal to ( {value} )",
                        "append": None}
...
APIs["hop_less"] = {"argument": ['row', 'header', 'obj'], "output": "bool",
                    ...
                    "to_nl": lambda t, col, value: f"( {col} ) of ( {t} ) is less than ( {value} )",
                    "append": None}
...
APIs["hop_less_eq"] = {"argument": ['row', 'header', 'obj'], "output": "bool",
                        ...
                        "to_nl": lambda t, col, value: f"( {col} ) of ( {t} ) is less than or equal to ( {value} )",
                        "append": None}
...
APIs["hop_greater"] = {"argument": ['row', 'header', 'obj'], "output": "bool",
                        ...
                        "to_nl": lambda t, col, value: f"( {col} ) of ( {t} ) is greater than ( {value} )",
                        "append": None}
...
APIs["hop_greater_eq"] = {"argument": ['row', 'header', 'obj'], "output": "bool",
                            ...
                            "to_nl": lambda t, col, value: f"( {col} ) of ( {t} ) is greater than or equal to ( {value} )",
                            "append": None}
...
APIs["row_diff"] = {"argument": ['row', 'row', 'header'], "output": "obj",
                    ...
                    "to_nl": lambda r1, r2, col: f"the difference between ( {col} ) of ( {r1} ) and ( {col} ) of ( {r2} )",
                    "append": None}
...
APIs["same"] = {"argument": ['row', 'row', 'header'], "output": "bool",
                ...
                "to_nl": lambda r1, r2, col: f"( {col} ) of ( {r1} ) is the same as ( {col} ) of ( {r2} )",
                "append": None}
...
APIs["row_less"] = {"argument": ['row', 'row', 'header'], "output": "bool",
                    ...
                    "to_nl": lambda r1, r2, col: f"( {col} ) of ( {r1} ) is less than ( {col} ) of ( {r2} )",
                    "append": None}
...
APIs["row_less_eq"] = {"argument": ['row', 'row', 'header'], "output": "bool",
                        ...
                        "to_nl": lambda r1, r2, col: f"( {col} ) of ( {r1} ) is less than or equal to ( {col} ) of ( {r2} )",
                        "append": None}
...
APIs["row_greater"] = {"argument": ['row', 'row', 'header'], "output": "bool",
                        ...
                        "to_nl": lambda r1, r2, col: f"( {col} ) of ( {r1} ) is greater than ( {col} ) of ( {r2} )",
                        "append": None}
...
APIs["row_greater_eq"] = {"argument": ['row', 'row', 'header'], "output": "bool",
                            ...
                            "to_nl": lambda r1, r2, col: f"( {col} ) of ( {r1} ) is greater than or equal to ( {col} ) of ( {r2} )",
                            "append": None}
...
APIs['less_eq'] = {"argument": ['obj', 'obj'], 'output': 'bool',
                    ...
                    "to_nl": lambda t1, t2: f"( {t1} ) is less than or equal to ( {t2} )",
                    'append': None}
...
APIs['ge'] = {"argument": ['obj', 'obj'], 'output': 'bool',
                ...
                "to_nl": lambda t1, t2: f"( {t1} ) is greater than or equal to ( {t2} )",
                'append': None}
...
APIs['mode'] = {"argument": ['row', 'row'], 'output': 'bool',
                ...
                "to_nl": lambda r1, r2: f"( {r1} ) dominates ( {r2} ) with more than half of rows",
                'append': None}
...
APIs['all'] = {"argument": ['row', 'row'], 'output': 'bool',
                ...
                "to_nl": lambda r1, r2: f"( {r1} ) takes all rows of ( {r2} )",
                'append': None}
