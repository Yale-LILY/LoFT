...
class DateTime(object):
    def __init__(self, year=-1, month=-1, day=-1):
        ...
        if not (isinstance(month, int) and (month == -1 or 1 <= month <= 12)): print(month)
    ...
    def __ne__(self, other):
        ...
        if other.is_month_only:
            ...
            return self.month != other.month or self.day != other.day
        elif other.day == -1:
            return self.month != other.month or self.year != other.year
    ...
    def from_string(date_string):
        ...
        year = -1 if data[0].lower() in ('xxxx', 'xx') else int(data[0])
        month = -1 if data[1].lower() == 'xx' else int(data[1])
        day = -1 if data[2].lower() == 'xx' else int(data[2])
